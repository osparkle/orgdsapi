...
         <textarea rows="4" placeholder="Comma-separated recipient list" name="recipients"></textarea>
      <p><strong>Message</strong> :<br />
         <textarea placeholder="Type message here" name="message" rows="5" ></textarea></p>
		...
		<p>
			...
			<input type="radio" name="type" required="required" value="0" checked="checked" /> Plain Text<br>
			<input type="radio" name="type" required="required" value="1" /> Flash Message
		</p>
		<p>
			<strong>Schedule Date & Time </strong> :<br>
			<input type="text" placeholder="YYYY-MM-DD HH:MM" name="schedule" required="required" value="<?= date('Y-m-d H:i') ?>" />
		</p>
